    ...
    <div className="login-screen">
      ...
      {denied ? (
        <div className="login-denied" role="alert">
          <span>🔒</span>
          <span>Account non autorizzato.</span>
        </div>
      ) : (
        <button
        ...
        >
          {loading ? (
            ...
            <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden>
              ...
              <path fill="currentColor" d="M9 3.58c1.321 0 2.508.454 3.44 1.345l2.582-2.58C13.463.891 11.426 0 9 0A8.997 8.997 0 0 0 .957 4.958L3.964 6.29C4.672 4.163 6.656 3.58 9 3.58z"/>
            </svg>
          )}
